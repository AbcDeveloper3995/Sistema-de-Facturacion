...
const format = (fila) => {
    ...
    html += '</thead>';
    html += '<tbody>';
    $.each(fila.det, function (key, value) {
        html += '<tr>';
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="/erp/sale/invoice/pdf/'+row.id+'/"  class="btn btn-info btn-xs btn-flat"><i class="fas fa-file-pdf"></i></a> ';
                    return buttons;
                }
            },
        ],
