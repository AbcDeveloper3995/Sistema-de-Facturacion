    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search_report':
                ...
                subtotal = search.aggregate(resultado=Coalesce(Sum('subtotal'), 0)).get('resultado')
                iva = search.aggregate(resultado=Coalesce(Sum('iva'), 0)).get('resultado')
                total = search.aggregate(resultado=Coalesce(Sum('total'), 0)).get('resultado')
